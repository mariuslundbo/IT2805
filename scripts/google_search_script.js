(function(opts_) {
	...
	var b = document.createElement("script"), c = opts_.protocol + "://" + opts_.uds + "/jsapi?autoload=", d = encodeURIComponent, e = '{"name":"search","version":"1.0","callback":"__gcse.scb"', f = window.__gcse;
	if (!f || !f.plainStyle) {
	...
	"cx" : "009970347708224543729:jcjemwvn9pi",
	"language" : "en",
	"theme" : "V2_DEFAULT",
	"uiOptions" : {
		"resultsUrl" : "",
